...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black overflow-hidden py-10">
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          ...
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <div
              className={`mb-8 transition-opacity duration-1000 delay-300 ${
            ...
            <div
              className={`flex flex-col sm:flex-row md:flex-col lg:flex-row gap-4 justify-center md:justify-start transition-opacity duration-1000 delay-500 ${
                isTextVisible ? "opacity-100" : "opacity-0"
              }`}
            >
              <Link
